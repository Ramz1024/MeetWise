  ...
  const outputs = [
    {
      ...
      desc: "Clean overview of key points and decisions",
      color: "blue",
    },
    {
      title: "Task Division",
      desc: "Auto-assign action items to team members",
      color: "green",
    },
    {
      title: "Action Flow",
      desc: "Visual workflow with dependencies & timelines",
      color: "purple",
    },
    {
      title: "Smart Chatbot",
      desc: "Ask questions about your meeting anytime",
      color: "pink",
    },
    {
      title: "Avatar Explainer",
      desc: "Friendly AI explains key points in simple terms",
      color: "yellow",
    },
  ];
